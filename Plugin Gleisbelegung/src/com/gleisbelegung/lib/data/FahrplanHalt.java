...
public class FahrplanHalt {
    ...
    private boolean crossing;
            //Hat der Zug hier eine Durchfahrt
    private FahrplanHalt vorgaenger;
            //Hat der Zug einen vorgaenger, wenn ja, dann hier der Flügelt- oder Wechselhalt gespeichert
    private Zug flaggedTrain;
            //Hat der Zug einen nachfolger, wenn ja, dann hier gespeichert, wenn nein dann null
    private boolean needUpdate;
    private long id;

    //Speichert gegebene Seite
    public FahrplanHalt(long abfahrt, Bahnsteig gleis, String flags,
    ...
    public void removeDrawnTo() {
        try {
            for (LabelContainer lc : drawnTo) {
                ...
                if (lc != null && flaggedTrain != null
                        && flaggedTrain.getFahrplan() != null
                        && flaggedTrain.getFahrplan().size() > 0
                        && flaggedTrain.getFahrplan(0) != null)
    ...
    public void addDrawnTo(LabelContainer lc) {
        try {
            ...
            if (flaggedTrain != null) {
                ...
                if (drawnTo != null && flaggedTrain.getFahrplan() != null
                        && flaggedTrain.getFahrplan().size() > 0
                        && flaggedTrain.getFahrplan(0) != null) {
    ...
    @Override public String toString() {
        return "FahrplanHalt{" + "ankuft=" + ankuft + ", abfahrt=" + abfahrt
                ...
                + ", vorgaenger=" + vorgaenger + ", crossing=" + crossing
